...
config="{ \
  ...
  \"INVENTORY_ASSETS_TABLE_NAME\": \"${INVENTORY_ASSETS_TABLE_NAME}\", \
  \"INVENTORY_CONDITIONS_TABLE_NAME\": \"${INVENTORY_CONDITIONS_TABLE_NAME}\", \
  \"INVENTORY_SENSORS_TABLE_NAME\": \"${INVENTORY_SENSORS_TABLE_NAME}\", \
